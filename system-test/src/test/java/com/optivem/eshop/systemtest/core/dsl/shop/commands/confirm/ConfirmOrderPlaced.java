...
public class ConfirmOrderPlaced extends BaseShopCommand<Void> {
    ...
    public ConfirmOrderPlaced orderNumberStartsWith(String expectedOrderNumberPrefix) {
    ...
    public Void execute() {
        ...
        if (expectedOrderNumberPrefix != null) {
            assertThat(response.getOrderNumber()).startsWith(expectedOrderNumberPrefix);
        }
